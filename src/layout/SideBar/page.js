...
const Sidebar = ({ isOpen }) => {
  const sidebarClasses = `fixed z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75 ${isOpen ? '' : 'hidden'}`;

  return (
    <aside id="sidebar" className={sidebarClasses} aria-label="Sidebar">
