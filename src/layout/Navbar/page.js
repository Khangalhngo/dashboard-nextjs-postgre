          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <button
                ...
                className="lg:hidden mr-2 text-gray-600 hover:text-gray-900 p-2 rounded focus:outline-none focus:ring-2 focus:ring-gray-200"
              >
              ...
              <a href="/" className="text-xl font-bold flex items-center lg:ml-2.5">
                ...
                <span className="self-center whitespace-nowrap">Socialense</span>
              </a>
              <form action="#" className="hidden lg:block lg:pl-32">
                ...
                <div className="mt-1 relative lg:w-64">
                  ...
                  <input type="text" name="email" id="topbar-search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full pl-10 p-2.5" placeholder="Search" />
                </div>
              </form>
            </div>
            <div className="flex items-center ">
              <input type='text' className='lg:hidden p-2.5 bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full' placeholder='Хайх' />
